...
\lstinputlisting[caption=Host PC Interface, label=lst:inter]{../src/pcsoft/inter.py}

\subsection {Data Acquisition}
\lstinputlisting[caption=Host PC Data Acquisition,label=lst:acqdata]{../src/pcsoft/acqdata.py}
